...
const startServer = async () => {
  try {
    ...
    // Try local MongoDB first (faster for development)
    const localMongoURI = 'mongodb://localhost:27017/chat-app';
    ...
    try {
      ...
      try {
        ...
        console.log('2. Or fix your Atlas connection:');
        console.log('   - Whitelist your IP in MongoDB Atlas');
        console.log('   - Check your connection string');
        console.log('   - Ensure your network allows MongoDB connections');
        process.exit(1);
      }
    }
  } catch (error) {
