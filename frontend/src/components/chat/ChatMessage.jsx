    ...
    >
      ...
      >
        ...
        <div 
          className={`
            ${isOwnMessage 
              ? 'bg-blue-600 dark:bg-blue-700 text-white rounded-tl-2xl rounded-tr-sm rounded-bl-2xl rounded-br-2xl' 
        ...
        >
          ...
          {/* Message tail for modern appearance */}
          <div 
            className={`absolute ${isOwnMessage ? 'right-[-6px]' : 'left-[-6px]'} top-0 w-2 overflow-hidden inline-block`}
          >
            <div 
              className={`
                h-3 w-3 transform ${isOwnMessage ? 'rotate-45 bg-blue-600 dark:bg-blue-700' : 'rotate-45 bg-white dark:bg-gray-700'}
